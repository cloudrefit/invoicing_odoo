...
----------------------
This script lives under ``migrations/19.0.2.32/`` — the target (new) version.
Odoo will execute it when upgrading from any older module version to 19.0.2.32.
"""
...
def migrate(cr, version):
    ...
    _logger.info(
        ...
        "target_version=19.0.2.32 from_version=%s",
        version,
    )
